...
WORD_COUNT = 0
ACTIONS = []
ELASTICSEARCH_INDEX_SEARCHED = 'index_reviews_restaurants_tripadvisor'
ELASTICSEARCH_INDEX = 'index_reviews_restaurants_tripadvisor_wordscloud'
...
if res:
    ...
    data = [
        entry['_source'][REVIEW_FIELD] for entry in res
    ]
    text = ''
    for dat in data:
        text += dat
