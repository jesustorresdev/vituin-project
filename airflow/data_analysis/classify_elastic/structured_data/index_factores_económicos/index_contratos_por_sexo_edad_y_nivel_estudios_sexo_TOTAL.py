...
ELASTICSEARCH_INDEX='index_contratos_sexo_edad_estudios'
...
try:
                    ...
                    "query": {
                        "bool": {
                            "must":[
                                ...
                                {"term":{"education": new_item['education']}},
    ...
    print '------'
    pass    #If it's the first gruop of elements indexed
