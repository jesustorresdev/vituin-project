...
sheet = 6
name_index = "index_valoraciones_infraestructuras"
...
fields_to_change = {'SERVICIOS GENERALES E INFRAESTRUCTURAS' : ['type','Servicios generales e infraestructuras'],'TOTAL PAÍSES' : ['place_origin','TOTAL']}
