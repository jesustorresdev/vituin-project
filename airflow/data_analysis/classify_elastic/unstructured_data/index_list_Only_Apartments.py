...
reference_description = ["id_only_apartments",
                         "title",
                         "price",
                         "numberReviews",
                         "mainBubbles",
...
ELASTICSEARCH_INDEX='index_list_only_apartments'
ELASTICSEARCH_INDEX_LIST_HOMES='index_list_homes_only_apartments'
ELASTICSEARCH_INDEX_LIST_DESCRIPTION='index_list_description_only_apartments'
