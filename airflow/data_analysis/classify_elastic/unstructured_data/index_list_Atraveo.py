...
ELASTICSEARCH_INDEX='index_list_atraveo'
ELASTICSEARCH_INDEX_LIST_HOMES='index_list_homes_atraveo'
ELASTICSEARCH_INDEX_LIST_DESCRIPTION='index_list_description_atraveo'
