...
homeway_files='homeway_homes_description3.csv'
            ...
            if not_page is False:
                ...
                while load is False:
                    try:
                        ...
                        try:
                            lng=driver.find_element_by_xpath("//meta[@property='homeaway:location:latitude']").get_attribute('content')
                            lat=driver.find_element_by_xpath("//meta[@property='homeaway:location:longitude']").get_attribute('content')
