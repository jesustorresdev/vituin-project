...
try:
    res = es.search(index='index_list_homes_only_apartments', body=doc, size=0)
...
for row in csv.reader(f):
    ...
    if(count!=0):
        ...
        try:
            ...
            res ={}
            try:
                res = es.search(index="index_list_homes_only_apartments", body={
                    "query": {
                        "match_phrase": {
            ...
            if not res or res['hits']['hits'] == []: #If there isn't result
                ...
                action = {
                    "_index": "index_list_homes_only_apartments",
                    "_type": "unstructured",
                    "_id": cont_id,
                    "_source": item
                }
