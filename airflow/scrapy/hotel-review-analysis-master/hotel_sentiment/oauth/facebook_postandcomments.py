...
params = {'access_token': \
'EAAE3vGes1K8BAAUQIDMlgZBaZBEvz5pJjZCrqYmRptAYs0zusp00IwqdFzTcom9zbyCImM4nKEFTlWZBQFzbhRGW9IQuPl6aBsGyZBAkYmhzpHbUAuZA7ufrNIVwKBN0VMtlfnrNLBQdr0hDBYIJrBCkqAylg5kKJuAY54HTXvaBzmGcsaDZA5IDZAD0I7aZAsHZAXkcO3npM1HgZDZD' \
}
...
while True:
    try:
        for element in data['data']:
            ...
            print(type(element['created_time']))
            now = datetime.datetime.today()
            print(type(now))
            if (now - element['created_time']).days < 1:
